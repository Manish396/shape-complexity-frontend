  ...
  _createClass(Paint, [
    ...
    },
    {
      ...
      value: function addLight(lights) {
        ...
        var directionalLight = new _Three2.default.DirectionalLight(
          this.lightColor
        );
        (_directionalLight$pos = directionalLight.position).set.apply(
          _directionalLight$pos,
          _toConsumableArray(lights)
        );
      ...
      value: function addInteractionControls() {
        ...
        if (this.orbitControls) {
          this.controls = new OrbitControls(
            this.camera,
            _reactDom2.default.findDOMNode(this.component)
          );
    ...
    },
    {
      ...
      value: function addToReactComponent() {
        ...
        _reactDom2.default
          .findDOMNode(this.component)
          .replaceChild(
            this.renderer.domElement,
            _reactDom2.default.findDOMNode(this.component).firstChild
          );
      },
